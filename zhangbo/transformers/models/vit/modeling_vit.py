...
class ViTEmbeddings(nn.Module):
    ...
    def forward(
        ...
        embeddings = self.patch_embeddings(pixel_values, interpolate_pos_encoding=interpolate_pos_encoding)# 整个图像先conv2d成一个14*14的. 作为embedding, 然后再加上tokne 和position
